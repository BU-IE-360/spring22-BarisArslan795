...
|   In conclusion, the correlation between total expenditure on car rental, interest rates for vehicle, and total number of tourists are examined in this homework. According to the results of the correlation matrix and behavior of the data, there is not a strong correlation between the data sets. Even though a strong correlation is not observed, there are moderate level correlations between some data sets: \
